...
starwars_2 <- rbind(starwars_2, list("Buðra Sarýkaya", 170, 60, "black", "fair", "brown", 26, "male", "masculine", "Dathomir", "Human", "Return of the Jedi", "Tsmeu-6 personal wheel bike", "Jedi Interceptor"))
filter(starwars_2, name == "Buðra Sarýkaya")
#Q5A:
